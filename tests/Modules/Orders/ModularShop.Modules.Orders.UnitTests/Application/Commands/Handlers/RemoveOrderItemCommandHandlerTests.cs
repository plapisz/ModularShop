...
public sealed class RemoveOrderItemCommandHandlerTests
{
    ...
    public RemoveOrderItemCommandHandlerTests()
    {
        ...
        _handler = new RemoveOrderItemCommandHandler(_orderRepository);
    }
    ...
    {
        // Arrange
        var command = new RemoveOrderItemCommand(Guid.NewGuid(), Guid.NewGuid());
    ...
    [Fact]
    public async Task GivenHandleAsync_WhenOrderFound_ThenRemovesItemFromOrder()
    {
        // Arrange
        var productId = Guid.NewGuid();
        var command = new RemoveOrderItemCommand(Guid.NewGuid(), productId);
